      ...
      <div className="container mx-auto px-6">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
          {services.map((service) => (
            ...
            >
              <service.icon className="w-10 h-10 text-copper mb-5 group-hover:scale-110 transition-transform" />
              ...
              <Button variant="ghost" size="sm" className="text-copper hover:text-copper/80 p-0 h-auto">
